...
export const updatePlan = async (planId, payload) => {
    ...
    try {
        ...
        try {
            ...
            throw new AppError(httpStatus.BAD_REQUEST, `Stripe product ${productIdToUse} is invalid. Cannot create price.`);
        }
        ...
        const isLifetimePlan = finalPlanName.toLowerCase().includes("lifetime") ||
        ...
        throw error instanceof AppError
            ? error
            : new AppError(httpStatus.INTERNAL_SERVER_ERROR, error);
    }
};
