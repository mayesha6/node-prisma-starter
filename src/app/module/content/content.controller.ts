...
const createContent = catchAsync(async (req, res) => {
  ...
  const result = await ContentService.createContent(type as string, payload);
...
const updateContent = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await ContentService.updateContent(type as string, id as string, { ...req.body });
...
const deleteContent = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await ContentService.deleteContent(type as string, id as string);
